...
//    A Mutable List is mutable means you can add or remove elements from a Mutable List.
    val numbers: MutableList<Int> = mutableListOf<Int>(1, 3, 4, 5)
...
//    A List is immutable means you can't add neither remove elements from a List.
    val teens: List<Int> = listOf<Int>(14, 18, 19)
    numbers.addAll(teens)
//    showMutableListIntValues(numbers)
//    println(numbers.size)

//------------------ Map and Mutable Map----------------------------
    val maleProgrammer = mutableMapOf<Int, String>()
    ...
    val newProgrammer = mapOf(6 to "Raaj", 6 to "Shivam")
    ...
    val programNameClone = arrayListOf("", "", "")
